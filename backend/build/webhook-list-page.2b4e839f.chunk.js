"use strict";(self.webpackChunkbackend=self.webpackChunkbackend||[]).push([[4001],{62:(U,h,t)=>{t.r(h),t.d(h,{default:()=>ue});var e=t(21272),s=t(51337),c=t(69267),u=t(71526),g=t(11273),L=t(42455),S=t(38413),D=t(55356),w=t(74773),l=t(30893),C=t(85963),A=t(4198),K=t(94061),_=t(35513),ee=t(40216),te=t(26127),V=t(90361),i=t(33363),F=t(50215),ne=t(98765),ae=t(25641),B=t(83997),E=t(92132),z=t(63891);const $=z.Ay.div`
...
`,D=(0,s.Ay)(c.a)`
  ...
  width: 100%;
  border: none;
`,w=({children:l,icon:C,...A})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(u.c,{}),(0,e.jsx)(D,{as:"button",background:"primary100",padding:5,...A,children:(0,e.jsxs)(g.s,{children:[(0,e.jsx)(S,{"aria-hidden":!0,background:"primary200",children:C}),(0,e.jsx)(c.a,{paddingLeft:3,children:(0,e.jsx)(L.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:l})})]})})]})},74773:(U,h,t)=>{t.d(h,{B:()=>c});var e=t(92132),s=t(83997);const c=({startActions:u,endActions:g})=>!u&&!g?null:(0,e.jsxs)(s.s,{justifyContent:"space-between",alignItems:"flex-start",paddingBottom:4,paddingLeft:10,paddingRight:10,children:[(0,e.jsx)(s.s,{gap:2,wrap:"wrap",children:u}),(0,e.jsx)(s.s,{gap:2,shrink:0,wrap:"wrap",children:g})]})}}]);
